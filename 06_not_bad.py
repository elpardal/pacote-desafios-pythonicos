...
Exemplo: 'The dinner is not that bad!' retorna 'The dinner is good!'zxzx
"""
import re
...
if __name__ == '__main__':
    ...
    test(not_bad, "E se tiver not bad e depois um not bad novamente", "E se tiver good e depois um good novamente")
